<?php
// Controller da entidade tipos_atendimentos.
// Gerencia os tipos/categorias que classificam os atendimentos do sistema.
...
class TiposAtendimentosController
{
    ...
    // Exclusão lógica: tipos vinculados a atendimentos existentes
    // não devem ser deletados fisicamente para preservar o histórico.
